...
// a metal dial called the "Freedom Trail Ring", and use the dial 
...
// You need to find the minimum number of steps 
...
// by rotating the ring clockwise or anticlockwise to make each character 
// of the string key aligned at 12:00 direction and then by pressing the center button.

// At the stage of rotating the ring to spell the key character key[i]:
// You can rotate the ring clockwise or anticlockwise one place, 
// which counts as 1 step. The final purpose of the rotation is to align one 
// of the string ring's characters at the 12:00 direction, 
